        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                    <div>
                        <h1 class="mb-1 text-white display-4">{{$category->name}}</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="tutor-wrap tutor-wrap-parent tutor-courses-wrap tutor-container course-archive-page" data-tutor_courses_meta="{&quot;course_filter&quot;:true,&quot;supported_filters&quot;:{&quot;category&quot;:&quot;category&quot;,&quot;difficulty_level&quot;:&quot;difficulty_level&quot;},&quot;loop_content_only&quot;:false,&quot;column_per_row&quot;:&quot;3&quot;,&quot;course_per_page&quot;:&quot;9&quot;,&quot;show_pagination&quot;:true}">
                    ...
                    <div class="tutor-d-block tutor-d-lg-none tutor-mb-32">
                        <div class="tutor-d-flex tutor-align-center tutor-justify-between">
                            <span class="tutor-fs-3 tutor-fw-medium tutor-color-black">{{__('messages.Courses')}}</span>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <h4 class="mb-0">{{__('messages.Filter')}}</h4>

                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <h4 class="dropdown-header px-0 mb-2">{{__('messages.Category')}}</h4>
                                            <div class="ms-n4">
                                                <div class="tutor-course-filter-nested-terms ps-4">
                                                    ...
                                                    <div class="form-check mb-1">
                                                        ...
                                                        <label class="form-check-label" for="tutor-course-filter-category-29">{{$CourseCategory->name}}</label>
                                                    </div>
                                                        @endforeach
                                                </div>
                                            ...
                                            <div class="border-top text-center pt-3">
                                                <button class="btn btn-success btn-block btn-sm">{{__('messages.Apply filter')}}</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tutor-courses tutor-courses-loop-wrap tutor-courses-layout-3 row row-cols-lg-3 row-cols-md-2 row-cols-12">
                                        ...
                                        <div class="tutor-card tutor-course-card">
                                            <div class="card mb-4 card-hover">
                                                ...
                                                <a href="{{route('course.single',['courseSlug'=>$course->slug])}}" class="card-img-top">
                                                    <img  src="{{ $course->images['tumbnail'] }}" class="card-img-top rounded-top-md wp-post-image" alt="{{$course->title}}" >
                                                <div class="card-body">
