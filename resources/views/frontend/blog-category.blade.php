                    ...
                    <div class="card mb-4 shadow-lg">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img width="32" height="32" src="{{$article->user->userimage()}}" class="avatar avatar-32 photo rounded-circle avatar-sm me-2" alt="" decoding="async" loading="lazy"  sizes="(max-width: 32px) 100vw, 32px"> </div>
                                <div class="col lh-1">
