                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 ">
                            ...
                            <div>
                                <ul class="list-group ">
                                    <?php $__currentLoopData = \App\Category::where(['parent_id'=>null,'category_mode'=>'course'])->with('sub_category')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('Admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ustashow\ustashow\resources\views/Admin/course/create.blade.php ENDPATH**/ ?>